...
// Case completeness score badge lives in a shared component so the list, the
// case detail and the QuickCreate draft screen all render the score identically.
